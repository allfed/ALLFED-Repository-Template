...
Please make sure that you define version numbers in your `environment.yml`. If you don't it will be really annoying to get your package to run again in the future. 
